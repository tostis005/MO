...
function emdo_2630_category_id(array $a): int {
...
function emdo_2630_product_slugs(array $a): array {
    $out=array();
...
function emdo_2630_render(array $a,array $product_slugs,bool $en=false): string {
...
function emdo_2630_image_id(): int {
...
function emdo_2630_save_en(int $id,array $a,string $content): void {
...
foreach($articles as $a){
    ...
    $id=(int)$r; set_post_thumbnail($id,$image_id); emdo_2630_save_en($id,$a,$en);
    $p=get_post($id);
...
if(!$out['verified']){ WP_CLI::error('Batch 26-30 verification failed.'); }
