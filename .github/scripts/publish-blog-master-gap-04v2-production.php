<?php
/**
 * Publish and verify EMDO master-list gap batch 04 v2 (10 bilingual articles).
...
foreach ( $articles as $article ) {
    ...
    $id = (int)$result;
    update_post_meta( $id, '_emdo_master_gap_04v2', EMDO_MASTER_GAP_04V2_MARKER );
...
$out=array(
    'marker'=>EMDO_MASTER_GAP_04V2_MARKER,'verified'=>true,'count'=>count($rows),
    'default_featured_image_id'=>$default_image_id,'posts'=>array_values($rows),'errors'=>array()
);
echo "EMDO_MASTER_GAP_04V2_BEGIN\n";
echo wp_json_encode($out,JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES)."\n";
echo "EMDO_MASTER_GAP_04V2_END\n";
