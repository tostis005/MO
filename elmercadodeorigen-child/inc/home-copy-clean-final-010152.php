<?php
/**
 * Copy final de Home 0.10.152.
 *
 * Mantiene el discurso abierto a cualquier categoría y concentra la propuesta
 * de valor en una idea sencilla: cada incorporación al mercado se selecciona
 * de forma individual y debe aportar una razón clara para estar aquí.
 *
...
function elmercado_home_copy_clean_final_010152( string $html ): string {
	...
	$copy = array(
		...
		'Directo de quien lo hace.' => 'Cada incorporación cuenta.',
		'Seleccionamos productor a productor y miramos primero el producto: ibéricos hechos con tiempo, aceites de almazara y una despensa que apetece volver a pedir. Tú eliges sabiendo quién está detrás.' => 'Seleccionamos cada proyecto de forma individual. Buscamos propuestas con algo propio y una razón clara para estar aquí. Así el mercado puede crecer sin perder el criterio.',
		'Entrar al mercado' => 'Ver el mercado',
		'Productor a productor' => 'Cada proyecto se revisa',
		'Cada uno con su puesto' => 'Una razón para estar aquí',
		'Compra fácil y cercana' => 'Compra clara y segura',

		'El producto manda' => 'Seleccionamos uno a uno',
		'Elegimos por sabor, materia prima y forma de hacer las cosas. Si no nos apetece tenerlo en casa, no tiene sentido que esté en el mercado.' => 'No buscamos llenar el catálogo. Cada incorporación tiene que aportar algo propio.',
		...
		'La compra es online, pero la idea sigue siendo sencilla: acercar a quien hace un buen producto a quien quiere disfrutarlo.' => 'El mercado puede sumar nuevas categorías sin perder su forma de seleccionar.',

		'De puesto en puesto' => 'Explora el mercado',
		'Una despensa que merece la pena conocer' => 'Descubre la selección',
		'Ibéricos con tiempo, aceites de almazara y otros productos elegidos productor a productor. Entra por lo que te apetezca y descubre quién está detrás.' => 'Nuevas categorías, nuevas propuestas y el mismo criterio en cada incorporación.',
		...
		'Primero vendimos lo nuestro. Después abrimos el mercado.' => 'Seleccionar antes que acumular.',
		'En 2017 pusimos en marcha una tienda online para vender directamente lo que producíamos. Vimos que había clientes que querían buen producto, trazabilidad y saber de dónde venía. El siguiente paso fue abrir espacio a otros productores que también merecía la pena conocer.' => 'El mercado está pensado para crecer sin convertirse en un catálogo sin filtro. Cada nueva incorporación se revisa de forma individual y tiene que aportar una razón clara para estar aquí.',
		...
		'Entra en los puestos, descubre cómo trabaja cada productor y encuentra esas cosas que uno acaba recomendando después por su nombre.' => 'Buscamos propuestas con algo propio y una forma de trabajar que marque la diferencia. Si crees que encaja, queremos conocerla.',
	);
