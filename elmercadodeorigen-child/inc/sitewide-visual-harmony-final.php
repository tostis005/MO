...
/* Sustituye la introducción antigua de Tienda sin tocar el contenido almacenado. */
add_action(
...
add_action(
	...
	static function (): void {
		...
		<style id="elmercado-sitewide-visual-harmony-final">
			body.elmercado-child-theme.woocommerce-shop .emo-shop-lead:not(.emo-shop-lead--final) {
				display: none !important;
			}
			body.elmercado-child-theme.woocommerce-shop .emo-shop-lead--final {
				width: 100% !important;
			...
			body.elmercado-child-theme.woocommerce-shop .emo-shop-lead--final p {
				width: 100% !important;
				max-width: none !important;
				margin: 0 !important;
				padding: 0 !important;
				color: #4b5d55 !important;
				font-size: clamp(14px, 1.2vw, 16px) !important;
				line-height: 1.6 !important;
				text-align: left !important;
			}

			/* Blog: una única superficie editorial, sin columna vacía a la derecha. */
			body.elmercado-editorial-content #content > .woostify-container,
			body.blog #content > .woostify-container {
				width: 100% !important;
				max-width: none !important;
			...
			body.blog #secondary,
			body.blog .site-content > .woostify-container > .widget-area {
				display: none !important;
			}
			body.elmercado-editorial-content .emo-journal-hero {
				margin: 0 !important;
				padding: clamp(18px, 3vw, 38px) clamp(16px, 3vw, 40px) 0 !important;
			...
			body.elmercado-editorial-content .emo-journal-hero__inner :is(h1,p,.emo-kicker) {
				color: #fff !important;
			}
			...
			body.elmercado-editorial-content .emo-article-card {
				...
				box-shadow: 0 12px 34px rgba(23,63,50,.06) !important;
				overflow: hidden !important;
			}
			body.elmercado-editorial-content .emo-article-card__media {
				overflow: hidden !important;
				border-radius: 0 !important;
			}

			/* Productores: el mismo lenguaje de paneles suaves y redondeados. */
			body.elmercado-producers-page #content > .woostify-container,
			body.elmercado-child-theme.wcfm-store-list-page #content > .woostify-container {
				width: 100% !important;
				max-width: 1440px !important;
			}
			...
			body.elmercado-child-theme.wcfm-store-list-page .emo-producers-intro :is(h2,p,.emo-kicker) {
			...
			body.elmercado-child-theme.wcfm-store-list-page #wcfmmp-stores-wrap :is(.wcfmmp-store-lists-sorting,.wcfmmp-store-list-sorting,.wcfmmp-store-list-sorting-wrapper,.wcfmmp-store-sorting,.emo-producers-sorting-hidden) {
				display: none !important;
			...
			body.elmercado-child-theme.wcfm-store-list-page #wcfmmp-stores-wrap :is(.wcfmmp-store-search-form,.wcfmmp-store-search-form-wrapper,.wcfmmp-store-lists-search) {
				border: 1px solid rgba(23,63,50,.11) !important;
			...
			body.elmercado-child-theme.wcfm-store-list-page #wcfmmp-stores-wrap ul.wcfmmp-store-wrap > li {
				border-radius: 22px !important;
				overflow: hidden !important;
			}
			...
			@media (max-width: 991px) {
				...
				html body.elmercado-child-theme .site-header .site-tools i {
				...
				html.sidebar-menu-open body.elmercado-child-theme .sidebar-menu :is(.dgwt-wcas-search-wrapp,.aws-container,.search-form) {
					...
					margin: 62px 16px 14px !important;
		...
		(() => {
			...
			if (window.jQuery) {
				window.jQuery(document.body).on('added_to_cart', () => {
					cartActionHappened = true;
				});
			}
			const removeStaleToast = () => {
				if (cartActionHappened) return;
				...
				root.querySelectorAll('select').forEach((select) => {
					...
					if (!candidate) {
						...
						for (let depth = 0; node && node !== root && depth < 4; depth += 1, node = node.parentElement) {
							...
							if (/(mostrando|resultado|ordenar|antigüedad|antiguedad)/.test(text)) candidate = node;
						}
					}
