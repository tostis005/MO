<?php
/**
 * Filtros base coherentes para tienda y categorías 0.10.193.
 *
 * Tienda: Precio → Categorías → Vendedor.
 * Categorías: Precio → Vendedor → filtros específicos de la categoría.
 * Excluye cuentas administrativas/no proveedor y unifica el aspecto del vendedor.
 *
...
/**
 * Determina si una cuenta representa realmente un proveedor del marketplace.
 *
 * La cuenta 1 se excluye expresamente: es la cuenta administrativa histórica
 * que puede figurar como autora de productos, pero no debe aparecer como tienda.
 */
function elmercado_core_filter_is_vendor( int $user_id ): bool {
	...
	$vendor_roles = array( 'wcfm_vendor', 'dc_vendor', 'vendor', 'seller' );
	return (bool) array_intersect( $vendor_roles, $roles );
}
...
/**
 * Obtiene los proveedores con productos publicados en el contexto actual.
 *
...
add_action(
	...
	static function (): void {
		...
		?>
		<style id="elmercado-catalog-core-filters-010193">
			...
			/* Tienda: misma jerarquía visual que Categorías. */
			...
			body.elmercado-child-theme.woocommerce-shop #emo-global-vendor-filter .emo-global-vendor-filter__list {
				margin:0 !important;
				padding:0 !important;
				list-style:none !important;
			}
			body.elmercado-child-theme.woocommerce-shop #emo-global-vendor-filter .emo-global-vendor-filter__item {
				margin:0 !important;
				padding:0 !important;
				border:0 !important;
			...
			body.elmercado-child-theme.woocommerce-shop #emo-global-vendor-filter .emo-global-vendor-filter__item:last-child {
				border-bottom:0 !important;
			}
			body.elmercado-child-theme.woocommerce-shop #emo-global-vendor-filter .emo-global-vendor-filter__item > a {
				display:flex !important;
				align-items:center !important;
			...
			body.elmercado-child-theme.woocommerce-shop #emo-global-vendor-filter .emo-global-vendor-filter__item:hover,
			body.elmercado-child-theme.woocommerce-shop #emo-global-vendor-filter .emo-global-vendor-filter__item.is-active {
				background:#f4f7f5 !important;
			}
			body.elmercado-child-theme.woocommerce-shop #emo-global-vendor-filter .emo-global-vendor-filter__item.is-active > a {
				color:#173f32 !important;
				font-weight:800 !important;
			}

			/* Categorías: mismo lenguaje compacto que los filtros específicos. */
			...
			body.elmercado-child-theme.tax-product_cat #emo-global-vendor-filter .emo-global-vendor-filter__list {
			...
			body.elmercado-child-theme.tax-product_cat #emo-global-vendor-filter .emo-global-vendor-filter__item {
				margin:0 !important;
				padding:0 4px !important;
				border:0 !important;
			...
			body.elmercado-child-theme.tax-product_cat #emo-global-vendor-filter .emo-global-vendor-filter__item > a {
				display:block !important;
			...
			body.elmercado-child-theme.tax-product_cat #emo-global-vendor-filter .emo-global-vendor-filter__item:hover {
				background:#f6f8f6 !important;
			}
			body.elmercado-child-theme.tax-product_cat #emo-global-vendor-filter .emo-global-vendor-filter__item.is-active {
				background:#edf4ef !important;
				box-shadow:inset 3px 0 0 #2f7d5d !important;
			}
			body.elmercado-child-theme.tax-product_cat #emo-global-vendor-filter .emo-global-vendor-filter__item.is-active > a {
				color:#173f32 !important;
				font-weight:750 !important;
			}
...
add_action(
	...
	static function (): void {
		...
		?>
		<script id="elmercado-catalog-core-filters-controller-010193">
		(() => {
			'use strict';
			...
			const place = () => {
				...
				const activeFilters = sidebar.querySelector(':scope > .emo-active-filter-chips[data-emo-global-active-filters="true"]');
				...
				const desired = (isCategory
					? [activeFilters, price, vendor, specific]
					: [activeFilters, price, categories, vendor]
				).filter(Boolean);
