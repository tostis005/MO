...
final class MDO_Reviews {
	...
	public static function admin_page(): void {
		...
		<div class="wrap mdo-sync-wrap mdo-reviews-admin">
			<h1>Reseñas</h1>
			<p>Importa, asigna y valida opiniones de producto, WCFM, Google y Trustpilot. Solo las publicadas se muestran públicamente. Los borradores pueden tener una tienda sugerida para revisión.</p>
